...
load("births_columbia.Rda")

# Load the map
map_col <- read_sf("U:/projects/3 Regional birth squeezes/Subnational_birth_squeezes/data/columbia_map/col_admbnda_adm1_mgn_20200416.shp")
...
# Save the result
save(tfrs_col, file = "tfr_col.Rda")
save(asfr_col, file = "asfr_col.Rda")
